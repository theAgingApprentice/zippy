...
const int8_t G_MOT1_ENA = PIN_10_LBL_A5; // PWM speed of motor 1. Physical pin 10.
const int8_t G_MOT2_ENB = PIN_11_LBL_SCK; // PWM speed of motor 2. Physical pin 11.
const int8_t G_RESET_GREEN_LED = PIN_21_LBL_15; // Green LED in reset button. Physical pin 12.
const int8_t G_MOT1_ENCA = PIN_13_LBL_MI; // Motor 1 hall effect A. Physical pin 13.
const int8_t G_MOT1_ENCB = PIN_14_LBL_RX; // Motor 1 hall effect B. Physical pin 14.
...
const int8_t G_MOT1_DIR1 = PIN_17_LBL_SDA; // Direction of motor 1. Physical pin 17.
const int8_t G_MOT1_DIR2 = PIN_18_LBL_SCL; // Direction of motor 1. Physical pin 18.
...
const int8_t G_MOT2_DIR3 = PIN_24_LBL_12; // Direction of motor 2. Physical pin 24.
const int8_t G_MOT2_DIR4 = PIN_25_LBL_13; // Direction of motor 2. Physical pin 25.
